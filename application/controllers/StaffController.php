...
class StaffController extends Zend_Controller_Action
{
    ...
    public function associaproblemiAction()
    {
        ...
        foreach ($associazioni as $associazione) {
            ...
            array_push($elencoassociazioni, ['idassociazione' => $idassociazione, 'problema'=>$dati['problema'], 'idprodotto'=> $idprodotto]);
            $c++;
        }
        ...
        $elencoproblemiform->setAction($this->_helper->url->url([
            'controller' => 'staff',
    ...
    public function modificaproblemaAction()
    {
        ...
        $this->_problemaform2->setAction($this->_helper->url->url([
            'controller' => 'staff',
